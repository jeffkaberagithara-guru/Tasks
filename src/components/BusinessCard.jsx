function BusinessCard({name, title, image, phone}) {
    return (
        <div className="p-4 mt-30 sm:p-5 w-full max-w-xs sm:max-w-sm border cursor-pointer rounded-lg shadow-md hover:shadow-lg transition-all duration-300 bg-blue-950 text-white">
